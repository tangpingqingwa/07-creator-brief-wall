...
/** Confirm sheet HTML. Terms + URL first. Occupied hops stay a later fact after terms. Occupied $bid stays a later fact after terms. Leave is POST /r/:id. GET does not count. */
