...
Empty week: honest empty state. Do not seed fake briefs. Empty plaster already leads with Claim #1, so it has no Post a brief hop, no first-write Post after Open, no first-read Open after Post, and no second Post concentrate after Open is re-concentrated.
